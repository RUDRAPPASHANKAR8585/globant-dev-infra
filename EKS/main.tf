...
module "eks" {
  ...
  # private_subnet_ids                         = ["subnet-0e72dce5b8ec6e735", "subnet-0fde70555c7668b62"]#data.aws_subnets.private.ids
  # public_subnet_ids                          = ["subnet-0abddef8f10847692", "subnet-0886523aef29ec8f7"] #data.aws_subnets.public.ids
  # control_plane_subnet_ids                   = ["subnet-0e72dce5b8ec6e735", "subnet-0fde70555c7668b62", "subnet-0abddef8f10847692", "subnet-0886523aef29ec8f7"] #concat(data.aws_subnets.private.ids, data.aws_subnets.public.ids)
